  ...
  class Healthcare < Base
    ...
    def fill_in_healthcare_needs
      ...
      within '.medication' do
        if @hc.medications.on?
          choose 'Yes'
          @hc.medications.collection.each_with_index do |med, i|
    ...
    def fill_in_medical_contact
      fill_in 'clinician_healthcare_professional', with: @hc.clinician.healthcare_professional
      fill_in 'clinician_contact_number', with: @hc.clinician.contact_number
      click_button 'Save and continue'
    end
  end
end
