...
RSpec.feature 'detainees due to move', type: :feature do
  ...
  context 'when there are detainees due to move for the date provided' do
    scenario 'show associated escorts and incomplete gauges for all the PER components' do
      create(:escort, :with_complete_healthcare_assessment, date: '11/08/2016')
      create(:escort, :with_complete_risk_assessment, :with_complete_healthcare_assessment, date: '11/08/2016')
      create(:escort, :with_complete_healthcare_assessment, :with_complete_offences,  date: '11/08/2016')
      create(:escort, :with_complete_offences, :with_complete_healthcare_assessment, date: '11/08/2016')
      create(:escort, :completed, date: '11/08/2016')
    ...
    scenario 'shows escorts scoped in the establishment of the user' do
      ...
      create(:escort, :completed, date: move_date, from_establishment: bedford)
      create(:escort, :completed, date: move_date, from_establishment: bedford)
      create(:escort, :completed, date: move_date, from_establishment: brixton)
