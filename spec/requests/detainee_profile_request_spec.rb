...
RSpec.describe 'Detainee profile Requests', type: :request do
  ...
  describe "#show" do
    ...
    context "with an invalid escort ID" do
      it "throws a record not found exception" do
        expect { get "/detainees/xxx" }.to raise_exception ActiveRecord::RecordNotFound
      end
    end
  end
end
